...
P.tau = 0.004;  P.tauU = 0.005;    % time constant tau
P.k0 = 4; P.k1 = 0.4; P.k2 = 0.002; % static gain, rate param, accel param 
...
P.y0 = 10;  P.yp0 = 5;             % initial firing (sec via length, primary)
